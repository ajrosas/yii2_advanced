			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					...
					<div class="d-flex flex-column">
						<a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary"><?= ucwords(Yii::$app->user->identity->username) ?></a>
						<div class="text-muted mt-1"><?= Yii::$app->user->identity->role->name ?></div>
						<div class="navi mt-1">
					...
					<a href="custom/apps/user/profile-1/personal-information.html" class="navi-item">
						<div class="navi-link">
							...
							<div class="navi-text">
								...
								<div class="text-muted">Account Credentials
					...
					<span class="navi-item mt-2">
						<span class="navi-link">
                            <?= Html::beginForm(['/site/logout'], 'post'); ?>
                                <a><?= Html::submitButton('Sign Out',['class' => 'btn btn-sm btn-light-primary font-weight-bolder py-3 px-6']) ?></a>
                            <?= Html::endForm(); ?>
						</span>
					</span>
